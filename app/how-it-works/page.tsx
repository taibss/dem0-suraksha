    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[#DC2626] text-white">
        <div className="mx-auto max-w-4xl px-5 py-16">
          <span className="eyebrow text-white/70">How it works</span>
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-4xl px-5 py-16">
          <div className="grid grid-cols-1 gap-4">
            {STEPS.map((s) => (
              <div key={s.n} className="flex items-start gap-4 rounded-2xl border border-border/40 bg-[#0F172A] p-6">
                <div className="grid size-12 shrink-0 place-items-center rounded-xl bg-[#DC2626] font-mono text-sm font-bold text-white">
                  {s.n}
                </div>
                <div>
          ...
          <Link
            href="/help"
            className="mt-10 inline-flex items-center rounded-full border-2 border-[#DC2626] bg-[#DC2626] px-6 py-3 text-base font-semibold text-white shadow-[4px_4px_0_0_rgba(234,179,8,0.5)] transition-transform hover:-translate-y-0.5"
          >
            Start the triage →
          </Link>
        </div>
