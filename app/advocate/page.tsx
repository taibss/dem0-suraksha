...
const LEAF_TO_ISSUE: Record<string, string> = {
  upi_paid_blocked: "UPI/Money Fraud",
  qr_receive_scam: "UPI/Money Fraud",
  otp_pin_scam: "UPI/Money Fraud",
  remote_access_scam: "UPI/Money Fraud",
  fake_customer_care: "UPI/Money Fraud",
  unauthorised_transaction: "UPI/Money Fraud",
  telegram_investment: "UPI/Money Fraud",
  crypto_scam: "UPI/Money Fraud",
  fake_regulated_investment: "UPI/Money Fraud",
  task_investment: "UPI/Money Fraud",
  task_job_scam: "UPI/Money Fraud",
  job_fee_scam: "UPI/Money Fraud",
  visa_job_scam: "UPI/Money Fraud",
  equipment_deposit_job: "UPI/Money Fraud",
  sextortion_real: "Sextortion/Blackmail",
  sextortion_morphed: "Sextortion/Blackmail",
  sextortion_contact_threat: "Sextortion/Blackmail",
  sextortion_shared: "Sextortion/Blackmail",
  private_info_blackmail: "Sextortion/Blackmail",
  business_extortion: "Threats",
  false_case_threat: "Threats",
  repeat_extortion: "Threats",
  digital_arrest: "Digital Arrest",
  loan_app_harassment: "Loan App Harassment",
  loan_app_contacts: "Loan App Harassment",
  loan_app_morphed: "Loan App Harassment",
  fake_loan_extortion: "Loan App Harassment",
  fir_refused: "Police/FIR Issue",
  portal_delay: "Police/FIR Issue",
  bank_needs_cyber: "Police/FIR Issue",
  civil_matter_pushback: "Police/FIR Issue",
  threat_police_inaction: "Police/FIR Issue",
};
...
function AdvocatePage() {
  ...
  const initialIssue = LEAF_TO_ISSUE[rawIssue] || rawIssue;
